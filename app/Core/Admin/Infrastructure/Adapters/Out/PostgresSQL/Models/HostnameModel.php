...
/**
 * Eloquent Model for tb_cat_hostname table
 *
 * Maps PostgreSQL table to PHP object. Lives in Infrastructure layer.
 *
 * @property int $id_nu_hostname Primary key
 * @property string $sn_nombre Hostname de servidor o dirección IP
 * @property int $ind_activo Indicador activo (0=inactivo, 1=activo)
 * @property Carbon $created_at
 * @property Carbon $updated_at
 */
final class HostnameModel extends Model
{
    /**
